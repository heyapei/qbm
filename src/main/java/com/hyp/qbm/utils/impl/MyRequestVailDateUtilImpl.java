package com.hyp.qbm.utils.impl;


import com.hyp.qbm.exception.MyDefinitionException;
import com.hyp.qbm.utils.MyRequestVailDateUtil;
import com.hyp.qbm.utils.dateutil.MyDateUtil;
...
public class MyRequestVailDateUtilImpl implements MyRequestVailDateUtil {
    ...
    @Override
    public boolean validateSignMd5Date(HttpServletRequest request, String signKey, int minutes) throws MyDefinitionException{
     ...
     */
    @Override
    public boolean validateSignMd5(HttpServletRequest request, String signKey) throws MyDefinitionException {
